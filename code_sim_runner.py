...
SIMULATION_PROMPT = """You are a programmer tasked with verifying a plan to solve a given problem using the **{language}** programming language.
...
PLAN_REFINEMENT_PROMPT = """You are a programmer tasked with generating appropriate plan to solve a given problem using the **{language}** programming language. You already have a wrong plan. Correct it so that it can generate correct plan.
...
def main():
    ...
    for _, row in pd_df.iterrows():
        ...
        for plan_no in range(1, max_plan_try + 1):
            ...
            simulation_input_prompt = SIMULATION_PROMPT.format(
                language=language,
